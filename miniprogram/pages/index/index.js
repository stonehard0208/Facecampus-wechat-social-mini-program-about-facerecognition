...
Page({
  ...
  modalcnt:function(){  
    wx.showModal({  
        title: '提示',  
        content: '点击开始签到，在距离教室一千米范围内，上传人脸图片，若识别人脸为该门课程学生，则签到成功',  
  ...
  findSchool(){
    ...
    var qqmap = new QQMapWX({
      key:'H2SBZ-DEIL3-TYL34-3V3HX-VZIXV-73BKR'
    });

    qqmap.calculateDistance({
      from:{
        latitude:23.146102,
        longitude:113.027058
      },
      to:[{
        latitude:23.15351,
        longitude:113.03424
      ...
      success:function(res){
        ...
        if(hw && hw !== -1&&hw<2000)
        {
            //console.log("距离小于2km，即将开启人脸识别")
            wx.showModal({  
              title: '提示',  
              content: '距离教室距离小于2km，即将开启人脸识别',  
              success: function(res) {  
                  if (res.confirm) {  
                  console.log('用户点击确定');
                  wx.navigateTo({
